...
cd target/release
RUST_LOG=info ./index_server --node-id 0 --index-config-path /mnt/muopdb/indices --index-data-path /mnt/muopdb/data --port 9002 --log-brokers localhost:19092,localhost:29092,localhost:39092
