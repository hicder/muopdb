...
pub struct MultiSpannBuilder {
    ...
    bloom_filter: RwLock<Option<BlockedBloomFilter>>,
...
impl MultiSpannBuilder {
    ...
    pub fn build(&self) -> Result<()> {
        ...
        let mut bloom_filter =
            BlockedBloomFilter::new(self.doc_id_counts.load(Ordering::Relaxed) as usize, FPR);
        ...
        *self.bloom_filter.write() = Some(bloom_filter);
    ...
    pub fn bloom_filter(&self) -> &RwLock<Option<BlockedBloomFilter>> {
        &self.bloom_filter
    }
