...
impl SpannReader {
    ...
    pub fn read(&self) -> Result<Spann> {
        ...
        let centroids = HnswReader::new(centroid_path).read::<NoQuantizer<L2DistanceCalculator>>()?;
        let posting_lists =
            IvfReader::new(posting_list_path).read::<NoQuantizer<L2DistanceCalculator>, L2DistanceCalculator>()?;
